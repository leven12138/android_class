...
public class MainActivity extends AppCompatActivity {
    ...
    public List<Message> getMessageFromRemote (String studentId) {
        String urlStr =
                String.format(Constants.BASE_URL + "messages");
        List<Message> result = null;
        MessageListResponse messageListResponse;
        try {
            if ( studentId!= null ){
                urlStr += "?student_id=" + Constants.STUDENT_ID;
            }
            ...
            if ( conn.getResponseCode() == 200) {
                ...
                messageListResponse = new Gson().fromJson(reader, MessageListResponse.class);
